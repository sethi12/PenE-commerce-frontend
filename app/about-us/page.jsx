...
export default function AboutPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-paper font-body text-ink transition-colors duration-500 selection:bg-brass selection:text-paper">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute left-[10%] top-[-10%] h-[600px] w-[600px] rounded-full bg-brass/10 blur-[150px]"
        />
        <motion.div
          animate={{ scale: [1, 1.2, 1], opacity: [0.2, 0.4, 0.2] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          className="absolute right-[-10%] top-[30%] h-[500px] w-[500px] rounded-full bg-brass/5 blur-[120px]"
        />
        <div className="absolute bottom-[-10%] left-[-5%] h-[450px] w-[450px] rounded-full bg-line/20 blur-[120px]" />
      </div>

      <div className="relative z-10 mx-auto max-w-7xl space-y-32 px-6 py-20 lg:px-10 lg:py-32">
        ...
        >
          ...
          <motion.h1 variants={fadeUp} className="text-5xl font-semibold leading-tight tracking-tight text-ink md:text-7xl">
            Where tactile heritage meets <br className="hidden md:block" />
            <span className="italic text-brass">architectural innovation.</span>
          </motion.h1>

          <motion.p variants={fadeUp} className="mx-auto max-w-2xl text-lg font-light leading-relaxed text-graphite md:text-xl">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="group relative lg:col-span-6">
            <div className="relative flex h-[450px] w-full flex-col justify-end overflow-hidden rounded-[2rem] border border-line bg-paper-raised p-8 shadow-2xl transition-transform duration-700 hover:scale-[1.02] sm:h-[550px]">
              
              {/* Optional: Add an actual image here if you have one in your public folder */}
              {/* <Image src="/atelier.jpg" alt="PenZone Atelier" fill className="object-cover opacity-80 mix-blend-overlay" /> */}
              ...
              <div className="relative z-20 space-y-4">
                ...
                <h3 className="text-3xl font-semibold leading-snug text-ink">
          ...
          {/* Text Narrative */}
          <motion.div variants={fadeUp} className="space-y-8 lg:col-span-6 lg:pl-10">
            <div className="flex items-center gap-2 font-mono text-sm uppercase tracking-widest text-brass">
              <Compass className="h-4 w-4" />
              Our Philosophy
            </div>

            <h2 className="text-4xl font-semibold leading-snug tracking-tight text-ink lg:text-5xl">
              Crafting instruments <br/> that earn their ink.
            </h2>

            <div className="space-y-6 text-base leading-relaxed text-graphite lg:text-lg">
              <p>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <div className="flex items-center gap-2 rounded-2xl border border-line bg-paper-raised px-5 py-3 font-mono text-xs text-ink transition-colors hover:border-brass/50">
        ...
        <section className="space-y-16">
          ...
          >
            <h2 className="text-4xl font-semibold tracking-tight text-ink">The PenZone Pillars</h2>
            ...
            {values.map((item) => {
              ...
              return (
                <motion.div
                  variants={fadeUp}
                  key={item.title}
                  className="group relative flex flex-col justify-between overflow-hidden rounded-[2rem] border border-line bg-paper-raised p-8 transition-all duration-500 hover:-translate-y-2 hover:border-brass/40 hover:shadow-2xl hover:shadow-brass/5"
                >
                  ...
                  <div className="relative z-10 space-y-6">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-brass/20 bg-brass/10 text-brass transition-transform duration-500 group-hover:scale-110">
        ...
        <motion.section 
          initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}
          className="relative overflow-hidden rounded-[2.5rem] border border-line bg-paper-raised p-10 sm:p-16"
        >
        ...
        <motion.section 
          initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}
          className="group relative flex flex-col items-center justify-between gap-10 overflow-hidden rounded-[2.5rem] border border-brass/30 bg-gradient-to-br from-brass/15 via-paper-raised to-paper p-10 md:flex-row sm:p-16"
        >
          ...
          <div className="relative z-10 space-y-4 text-center md:text-left">
            ...
            <p className="max-w-xl text-base text-graphite md:text-lg">
          ...
          <div className="relative z-10 shrink-0">
            <a
              href="/collections"
              className="group/btn inline-flex items-center gap-3 rounded-full bg-ink px-8 py-4 text-base font-medium text-paper transition-all hover:bg-brass hover:shadow-[0_0_20px_rgba(var(--brass-rgb),0.3)]"
            >
              Browse Collections
