    ...
    <div className="min-h-screen bg-paper px-6 py-24 lg:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-16 flex flex-col items-start gap-4">
          <span className="label-mono">The complete archive</span>
          ...
          <p className="max-w-xl font-body text-sm text-graphite sm:text-base">
            Every handcrafted barrel, nib grade, and archival release currently available from our workshop.
          </p>
        </div>
        ...
        {products.length === 0 ? (
          <div className="py-24 text-center font-body text-sm text-graphite">
            No instruments currently available in the shop.
          </div>
        ) : (
